...
## Validator Cohort (Pilot)

Members of the [Ambassador-Owned Validator](./ambassador-validator.md) pilot, and their on-call window.

| Agent | Time zone | On-call window | Joined cohort |
| --- | --- | --- | --- |
|  |  |  |  |
