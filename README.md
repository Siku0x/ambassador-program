...
[Orbinum Network](https://orbinum.network/) — privacy infrastructure institutions can actually use.

Orbinum is a Substrate-based Layer 1 with full EVM compatibility, built around a shielded pool and selective disclosure. Transactions are private by default, and their value and asset can be proven to a specific counterparty on demand — without exposing a spending key, and without asking anyone to trust an intermediary.

Most privacy chains force a choice: privacy or compliance. Orbinum is built on the premise that the choice is a false one, and that the chain which resolves it is the one institutions will use.

We are early. Public testnet launched in July 2026, mainnet and TGE are targeted for Q4 2026. The people who show up now shape what this ecosystem becomes.
...
- Good understanding of Orbinum's vision, architecture and current state of development.
- Experience with community engagement on social media (Telegram, Discord, meetups).
- Engaged in our community.
- Interested in growing and educating the community for Orbinum and privacy infrastructure generally.
- Committed to helping Orbinum become a community-owned network.

## Expectations

- Foster and grow a strong community in your respective region.
- Be transparent about your contributions and tasks.
- Translate official documentation, articles and announcements into your native language.
...
- Gain recognition as a representative of Orbinum Network.
- Privileged access to the core team, with insight into development before it is public.
- Shape the ecosystem at a stage where a single person's work is still visible in the outcome.
- Eligibility for the [Ambassador-Owned Validator Program](./ambassador-validator.md) — operate part of the network's consensus and earn from staking emissions. ORB is hard-capped at 1,000,000,000 with no perpetual inflation, so these emissions run for a finite period; please read [Emissions are finite](./ambassador-validator.md#emissions-are-finite--read-this-before-you-join) before joining.
- Develop a reputation within the program that can influence your future career path.
- Collaborate with notable individuals and projects across the Polkadot and privacy ecosystems.
...
- **Help others:** Willingly offer assistance, share knowledge, and encourage collaboration.
- **Be constructive:** Contribute positively to discussions by providing well-reasoned feedback and seeking solutions.
...
- **No impersonation:** Do not impersonate or falsely represent yourself as another individual or organisation, especially the Orbinum brand or any entity within the community.
- **No self-promotion:** Avoid excessive self-promotion, personal projects, or spamming within Orbinum's channels.
- **No harassment or hate speech:** Refrain from any form of harassment or hate speech.
- **No plagiarism:** Do not present someone else's work, ideas or content as your own without attribution or permission.
- **No price talk:** Avoid excessive discussion or speculation regarding ORB's price or investment-related topics.
...
Join the [Orbinum Discord](https://discord.com/invite/orbinum), introduce yourself in the community channels, and request the Ambassador role in `#ambassador-chat`.
